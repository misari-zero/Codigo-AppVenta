...
*/
(function (a) {
    "object" === typeof module && module.exports ? (a["default"] = a, module.exports = a) : "function" === typeof define && define.amd ? define("highcharts/modules/accessibility", ["highcharts"], function (r) {
        a(r);
        a.Highcharts = r;
        return a
    ...
    function r(a, g, q, n) {
        a.hasOwnProperty(g) || (a[g] = n.apply(null, q))
    }

    a = a ? a._modules : {};
    r(a, "modules/accessibility/utils/htmlUtilities.js", [a["parts/Utilities.js"], a["parts/Globals.js"]], function (a, g) {
        function l(a) {
            return a.replace(/&/g,
                "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&#x27;").replace(/\//g, "&#x2F;")
        }

        var n = a.merge, p = g.win, f = p.document;
        return {
            addClass: function (a, f) {
                a.classList ? a.classList.add(f) : 0 > a.className.indexOf(f) && (a.className += f)
            }, escapeStringForHTML: l, getElement: function (a) {
                return f.getElementById(a)
            }, getFakeMouseEvent: function (a) {
                if ("function" === typeof p.MouseEvent) return new p.MouseEvent(a);
                if (f.createEvent) {
                    var h = f.createEvent("MouseEvent");
                    if (h.initMouseEvent) return h.initMouseEvent(a,
                ...
                for (var f = a.childNodes.length; f--;) a.appendChild(a.childNodes[f])
            }, setElAttrs: function (a, f) {
                Object.keys(f).forEach(function (k) {
                    var e = f[k];
                    null === e ? a.removeAttribute(k) : (e = l("" + e), a.setAttribute(k, e))
                })
    ...
    r(a, "modules/accessibility/utils/chartUtilities.js", [a["modules/accessibility/utils/htmlUtilities.js"], a["parts/Utilities.js"]], function (a, g) {
        ...
        var f = a.stripHTMLTagsFromString, h = g.defined, x = g.find, k = g.fireEvent;
        return {
            getChartTitle: function (e) {
                return f(e.options.title.text || e.langFormat("accessibility.defaultChartTitle", {chart: e}))
            },
            getAxisDescription: function (e) {
                return f(e && (e.userOptions && e.userOptions.accessibility && e.userOptions.accessibility.description || e.axisTitle && e.axisTitle.textStr || e.options.id || e.categories && "categories" || e.dateTime && "Time" || "values"))
            }, getPointFromXY: function (e, d, b) {
                for (var m = e.length, c; m--;) if (c = x(e[m].points || [], function (c) {
                    return c.x === d && c.y === b
                })) return c
            }, getSeriesFirstPointElement: l, getSeriesFromName: function (e, d) {
                return d ? (e.series || []).filter(function (b) {
                    return b.name === d
                }) : e.series
            }, getSeriesA11yElement: n,
            unhideChartElementFromAT: p, hideSeriesFromAT: function (e) {
                (e = n(e)) && e.setAttribute("aria-hidden", !0)
            }, scrollToPoint: function (e) {
                var d = e.series.xAxis, b = e.series.yAxis, m = (null === d || void 0 === d ? 0 : d.scrollbar) ? d : b;
                if ((d = null === m || void 0 === m ? void 0 : m.scrollbar) && h(d.to) && h(d.from)) {
                    b = d.to - d.from;
                    if (h(m.dataMin) && h(m.dataMax)) {
                        var c = m.toPixels(m.dataMin), t = m.toPixels(m.dataMax);
                        e = (m.toPixels(e["xAxis" === m.coll ? "x" : "y"] || 0) - c) / (t - c)
                    } else e = 0;
    ...
    r(a, "modules/accessibility/KeyboardNavigationHandler.js", [a["parts/Utilities.js"]], function (a) {
        function l(a, l) {
            this.chart = a;
            this.keyCodeMap = l.keyCodeMap || [];
            this.validate = l.validate;
            this.init = l.init;
        ...
        l.prototype = {
            run: function (a) {
                var l = a.which || a.keyCode, f = this.response.noHandler, h = q(this.keyCodeMap, function (a) {
                    return -1 < a[0].indexOf(l)
                });
                h ? f = h[1].call(this, l, a) :
                    9 === l && (f = this.response[a.shiftKey ? "prev" : "next"]);
                return f
            }
        };
        return l
    });
    r(a, "modules/accessibility/utils/EventProvider.js", [a["parts/Globals.js"], a["parts/Utilities.js"]], function (a, g) {
        var l = g.addEvent;
        g = g.extend;
        var n = function () {
            this.eventRemovers = []
    ...
    r(a, "modules/accessibility/utils/DOMElementProvider.js",
        [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/utils/htmlUtilities.js"]], function (a, g, q) {
    ...
    r(a, "modules/accessibility/AccessibilityComponent.js", [a["parts/Globals.js"], a["parts/Utilities.js"],
        ...
        var l = a.win, k = l.document;
        a = g.extend;
        var e = g.fireEvent, d = g.merge, b = q.removeElement, m = q.getFakeMouseEvent, c = n.unhideChartElementFromAT;
        h.prototype = {
            initBase: function (b) {
                this.chart = b;
                ...
                var t = b.element, w = this.createElement("button"),
                    f = d({"aria-label": t.getAttribute("aria-label")}, m);
                Object.keys(f).forEach(function (b) {
                    null !== f[b] && w.setAttribute(b, f[b])
                });
                w.className = "highcharts-a11y-proxy-button";
                k && this.addEvent(w, "click", k);
                this.setProxyButtonStyle(w);
                this.updateProxyButtonPosition(w, e || b);
                this.proxyMouseEventsForButton(t, w);
                a.appendChild(w);
                f["aria-hidden"] || c(this.chart,
                    w);
                return w
                ...
                var d = this;
                "click touchstart touchend touchcancel touchmove mouseover mouseenter mouseleave mouseout".split(" ").forEach(function (t) {
                    var a = 0 === t.indexOf("touch");
                    d.addEvent(c, t, function (c) {
                        var t = a ? d.cloneTouchEvent(c) :
                            d.cloneMouseEvent(c);
                        b && d.fireEventOnWrappedOrUnwrappedElement(b, t);
                        c.stopPropagation();
                        c.preventDefault()
                    })
                })
            }, cloneMouseEvent: function (b) {
                if ("function" === typeof l.MouseEvent) return new l.MouseEvent(b.type, b);
                if (k.createEvent) {
                    var c = k.createEvent("MouseEvent");
                    if (c.initMouseEvent) return c.initMouseEvent(b.type, b.bubbles, b.cancelable, b.view || l, b.detail, b.screenX, b.screenY, b.clientX, b.clientY, b.ctrlKey, b.altKey, b.shiftKey, b.metaKey, b.button, b.relatedTarget), c
                }
                return m(b.type)
                ...
                if ("function" === typeof l.TouchEvent) return c = new l.TouchEvent(b.type, {
                    touches: c(b.touches),
    ...
    r(a, "modules/accessibility/KeyboardNavigation.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/utils/htmlUtilities.js"],
        ...
        var f = a.doc, h = a.win, x = g.addEvent, k = g.fireEvent, e = q.getElement;
        x(f, "keydown", function (d) {
        ...
        l.prototype = {
            init: function (d, b) {
                ...
                if (a) {
                    var c =
                        a.run(d);
                    c === a.response.success ? b = !0 : c === a.response.prev ? b = this.prev() : c === a.response.next && (b = this.next());
                ...
                d = !(d && !1 === d.enabled);
                var b = this.chart, a = b.container;
                b.renderTo.hasAttribute("tabindex") &&
                (a.removeAttribute("tabindex"), a = b.renderTo);
                this.tabindexContainer = a;
                var c = a.getAttribute("tabindex");
                d && !c ? a.setAttribute("tabindex", "0") : d || b.container.removeAttribute("tabindex")
                ...
                this.eventProvider.addEvent(d, "focus", function (c) {
                    c = c || h.event;
                    c.relatedTarget && b.container.contains(c.relatedTarget) || a.exiting ? a.exiting = !1 : (b.renderTo.focus(), c.preventDefault(), a.modules && a.modules.length && (a.currentModuleIx =
    ...
    r(a, "modules/accessibility/components/LegendComponent.js", [a["parts/Globals.js"], a["parts/Legend.js"], a["parts/Utilities.js"], a["modules/accessibility/AccessibilityComponent.js"], a["modules/accessibility/KeyboardNavigationHandler.js"], a["modules/accessibility/utils/htmlUtilities.js"]],
        function (a, g, q, n, p, f) {
            function h(b) {
                var c = b.legend && b.legend.allItems, d = b.options.legend.accessibility || {};
                return !(!c || !c.length || b.colorAxis && b.colorAxis.length || !1 === d.enabled)
            }

            var l = q.addEvent, k = q.extend, e = q.find, d = q.fireEvent, b = f.stripHTMLTagsFromString,
                m = f.removeElement;
            a.Chart.prototype.highlightLegendItem = function (b) {
                ...
                if (c[b]) {
                    ...
                    a = this.legend;
                    var e = a.allItems[b].pageIx, m = a.currentPage;
                    "undefined" !==
                    typeof e && e + 1 !== m && a.scroll(1 + e - m);
            ...
            l(g, "afterColorizeItem", function (b) {
                var c = b.item;
            ...
            k(a.prototype, {
                init: function () {
                    ...
                    this.addEvent(g, "afterPositionItem", function (c) {
                        this.chart === b.chart && this.chart.renderer && b.updateProxyPositionForItem(c.item)
                    })
                }, updateLegendItemProxyVisibility: function () {
                    var b = this.chart.legend, a = b.currentPage || 1, d = b.clipHeight || 0;
                    (b.allItems || []).forEach(function (c) {
                        var e = c.pageIx || 0, m = c._legendItemPos ? c._legendItemPos[1] : 0,
                            t = c.legendItem ? Math.round(c.legendItem.getBBox().height) :
                                0;
                        e = m + t - b.pages[e] > d || e !== a - 1;
                        c.a11yProxyElement && (c.a11yProxyElement.style.visibility = e ? "hidden" : "visible")
                    })
                }, onChartRender: function () {
                    h(this.chart) ? this.updateProxiesPositions() : this.removeProxies()
                }, updateProxiesPositions: function () {
                    for (var b = 0, a = this.proxyElementsList; b < a.length; b++) {
                        var d = a[b];
                        this.updateProxyButtonPosition(d.element, d.posElement)
                    }
                    ...
                    m(this.legendProxyGroup);
                    this.proxyElementsList = []
                }, addLegendProxyGroup: function () {
                    var b = this.chart.options.accessibility,
                        a = this.chart.langFormat("accessibility.legend.legendLabel", {});
                    ...
                    if (c.legendItem && c.legendGroup) {
                        var a = this.chart.langFormat("accessibility.legend.legendItem", {
                            chart: this.chart,
                            itemName: b(c.name)
                        }), d = c.legendGroup.div ? c.legendItem : c.legendGroup;
                    ...
                    var b = this.keyCodes, a = this;
                    return new p(this.chart, {
                        keyCodeMap: [[[b.left, b.right, b.up, b.down], function (b) {
                            return a.onKbdArrowKey(this, b)
                        }], [[b.enter, b.space], function () {
                            return a.onKbdClick(this)
                        }]], validate: function () {
                            return a.shouldHaveLegendNavigation()
                        }, init: function (b) {
                            return a.onKbdNavigationInit(b)
                        }
                    })
                }, onKbdArrowKey: function (b, a) {
                    var c = this.keyCodes, d = b.response, e = this.chart, m = e.options.accessibility,
                        f = e.legend.allItems.length;
                    a = a === c.left || a === c.up ? -1 : 1;
                    return e.highlightLegendItem(this.highlightedLegendItemIx + a) ? (this.highlightedLegendItemIx += a, d.success) : 1 < f && m.keyboardNavigation.wrapAround ? (b.init(a), d.success) : d[0 < a ? "next" : "prev"]
                    ...
                    var b = this.chart, a = b.colorAxis && b.colorAxis.length,
                    ...
                    var c = this.chart, a = c.legend.allItems.length - 1;
                    b = 0 < b ? 0 : a;
    ...
    r(a, "modules/accessibility/components/MenuComponent.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/AccessibilityComponent.js"], a["modules/accessibility/KeyboardNavigationHandler.js"], a["modules/accessibility/utils/chartUtilities.js"],
        ...
        function h(a) {
            return a.exportSVGElements && a.exportSVGElements[0]
        }

        g = g.extend;
        var l = p.unhideChartElementFromAT, k = f.removeElement, e = f.getFakeMouseEvent;
        a.Chart.prototype.showExportMenu = function () {
            var a = h(this);
            if (a && (a = a.element, a.onclick)) a.onclick(e("click"))
        };
        a.Chart.prototype.hideExportMenu = function () {
            var a = this.exportDivElements;
            a && this.exportContextMenu && (a.forEach(function (b) {
        ...
        a.Chart.prototype.highlightExportItem = function (a) {
            ...
            if (b && "LI" === b.tagName && (!b.children || !b.children.length)) {
                ...
                b.focus && c && b.focus();
                if (d && d.onmouseout) d.onmouseout(e("mouseout"));
        ...
        g(a.prototype, {
            init: function () {
                ...
                var a = this.chart, b = a.options.accessibility;
                k(this.exportProxyGroup);
                var e = a.options.exporting,
                    c = h(a);
                e && !1 !== e.enabled && e.accessibility && e.accessibility.enabled && c && c.element && (this.exportProxyGroup = this.addProxyGroup("all" === b.landmarkVerbosity ? {
                ...
                }), b = b[0].parentNode, b.removeAttribute("aria-hidden"), b.setAttribute("aria-label", a.langFormat("accessibility.exporting.chartMenuLabel", {chart: a})))
            }, getKeyboardNavigation: function () {
                var a = this.keyCodes, b = this.chart, e = this;
                return new n(b, {
                    keyCodeMap: [[[a.left, a.up], function () {
                        ...
                        var a = e.exportButtonProxy, d = b.exportingGroup;
                ...
                a = a.response;
                for (var c = b.highlightedExportItemIx || 0; c--;) if (b.highlightExportItem(c)) return a.success;
                ...
                var b = this.chart, d = b.exportDivElements[b.highlightedExportItemIx], c = h(b).element;
                this.isExportMenuShown ? this.fakeClickEvent(d) : (this.fakeClickEvent(c),
    ...
    r(a, "modules/accessibility/components/SeriesComponent/SeriesKeyboardNavigation.js", [a["parts/Chart.js"], a["parts/Globals.js"], a["parts/Point.js"], a["parts/Utilities.js"], a["modules/accessibility/KeyboardNavigationHandler.js"], a["modules/accessibility/utils/EventProvider.js"], a["modules/accessibility/utils/chartUtilities.js"]], function (a, g, q, n, p, f, h) {
        function l(b) {
            var a = b.index, c = b.series.points, d = c.length;
            if (c[a] !== b) for (; d--;) {
                if (c[d] ===
                    b) return d
            } else return a
        ...
        function k(b) {
            var a = b.chart.options.accessibility.keyboardNavigation.seriesNavigation,
                c = b.options.accessibility || {}, d = c.keyboardNavigation;
            return d && !1 === d.enabled || !1 === c.enabled || !1 === b.options.enableMouseTracking || !b.visible || a.pointNavigationEnabledThreshold && a.pointNavigationEnabledThreshold <= b.points.length
        }

        function e(b) {
            var a = b.series.chart.options.accessibility;
            return b.isNull && a.keyboardNavigation.seriesNavigation.skipNullPoints || !1 === b.visible || k(b.series)
        }

        function d(b,
                   a, d, e) {
            var m = Infinity, u = a.points.length, f = function (b) {
                return !(c(b.plotX) && c(b.plotY))
            };
            if (!f(b)) {
                for (; u--;) {
                    var k = a.points[u];
                    if (!f(k) && (k = (b.plotX - k.plotX) * (b.plotX - k.plotX) * (d || 1) + (b.plotY - k.plotY) * (b.plotY - k.plotY) * (e || 1), k < m)) {
                        m = k;
                        var t = u
                    }
                }
                return c(t) ? a.points[t] : void 0
            }
        }
        ...
        function b(b) {
            ...
            return a = b.series.reduce(function (b, a) {
                return b || a.highlightFirstValidPoint()
            }, !1)
        }
        ...
        var c = n.defined;
        n = n.extend;
        var t = h.getPointFromXY,
            A = h.getSeriesFromName, z = h.scrollToPoint;
        g.Series.prototype.keyboardMoveVertical = !0;
        ["column", "pie"].forEach(function (b) {
            g.seriesTypes[b] && (g.seriesTypes[b].prototype.keyboardMoveVertical = !1)
        });
        ...
        a.prototype.highlightAdjacentPoint = function (b) {
            var a = this.series, c = this.highlightedPoint, d =
                c && l(c) || 0, m = c && c.series.points, u = this.series && this.series[this.series.length - 1];
            u = u && u.points && u.points[u.points.length - 1];
            if (!a[0] || !a[0].points) return !1;
            if (c) {
                if (a = a[c.series.index + (b ? 1 : -1)], d = m[d + (b ? 1 : -1)], !d && a && (d = a.points[b ? 0 : a.points.length - 1]), !d) return !1
            } else d = b ? a[0].points[0] : u;
            return e(d) ? (a = d.series, k(a) ? this.highlightedPoint = b ? a.points[a.points.length - 1] : a.points[0] : this.highlightedPoint = d, this.highlightAdjacentPoint(b)) : d.highlight()
        };
        g.Series.prototype.highlightFirstValidPoint = function () {
            var b =
                this.chart.highlightedPoint, a = (b && b.series) === this ? l(b) : 0;
            b = this.points;
            var c = b.length;
            if (b && c) {
                for (var d = a; d < c; ++d) if (!e(b[d])) return b[d].highlight();
                for (; 0 <= a; --a) if (!e(b[a])) return b[a].highlight()
            }
            return !1
        };
        a.prototype.highlightAdjacentSeries = function (b) {
            var a, c = this.highlightedPoint;
            var e = (a = this.series && this.series[this.series.length - 1]) && a.points && a.points[a.points.length - 1];
            if (!this.highlightedPoint) return a = b ? this.series && this.series[0] : a, (e = b ? a && a.points && a.points[0] : e) ? e.highlight() : !1;
            a = this.series[c.series.index + (b ? -1 : 1)];
            if (!a) return !1;
            e = d(c, a, 4);
            if (!e) return !1;
            if (k(a)) return e.highlight(), b = this.highlightAdjacentSeries(b), b ? b : (c.highlight(), !1);
            e.highlight();
            return e.series.highlightFirstValidPoint()
        };
        a.prototype.highlightAdjacentPointVertical = function (b) {
            var a = this.highlightedPoint, d = Infinity, m;
            ...
            this.series.forEach(function (f) {
                k(f) || f.points.forEach(function (k) {
                    if (c(k.plotY) && c(k.plotX) && k !== a) {
                        ...
                        t = Math.abs(u) * Math.abs(u) + t * t * 4;
                        f.yAxis && f.yAxis.reversed && (u *= -1);
                        !(0 >= u && b || 0 <= u && !b || 5 > t || e(k)) && t < d && (d = t, m = k)
                    }
                })
            });
        ...
        n(m.prototype, {
            init: function () {
                var a = this, c = this.chart, d = this.eventProvider = new f;
                d.addEvent(g.Series, "destroy", function () {
                ...
                d.addEvent(c, "drilldown", function (b) {
                    b = b.point;
                    var c = b.series;
                ...
                var b = this.lastDrilledDownPoint, a = this.chart, d = b && A(a, b.seriesName), e;
                b && d && c(b.x) && c(b.y) && (e = t(d, b.x, b.y));
                ...
                var b = this, a = this.keyCodes, c = this.chart, d = c.inverted;
                return new p(c, {
                    keyCodeMap: [[d ? [a.up, a.down] :
                        [a.left, a.right], function (a) {
                        return b.onKbdSideways(this, a)
                    }], [d ? [a.left, a.right] : [a.up, a.down], function (a) {
                        return b.onKbdVertical(this, a)
                    }], [[a.enter, a.space], function () {
                        c.highlightedPoint && c.highlightedPoint.firePointEvent("click");
                        return this.response.success
                    }]], init: function (a) {
                        return b.onHandlerInit(this, a)
                    }, terminate: function () {
                        return b.onHandlerTerminate()
                    }
                })
            }, onKbdSideways: function (b, a) {
                var c = this.keyCodes;
                return this.attemptHighlightAdjacentPoint(b, a === c.right || a === c.down)
            }, onKbdVertical: function (b,
                                        a) {
                var c = this.chart, d = this.keyCodes;
                a = a === d.down || a === d.right;
                d = c.options.accessibility.keyboardNavigation.seriesNavigation;
                if (d.mode && "serialize" === d.mode) return this.attemptHighlightAdjacentPoint(b, a);
                c[c.highlightedPoint && c.highlightedPoint.series.keyboardMoveVertical ? "highlightAdjacentPointVertical" : "highlightAdjacentSeries"](a);
                return b.response.success
            }, onHandlerInit: function (a, c) {
                var d = this.chart;
                if (0 < c) b(d); else {
                    c = d.series.length;
                    for (var e; c-- && !(d.highlightedPoint = d.series[c].points[d.series[c].points.length -
                    1], e = d.series[c].highlightFirstValidPoint());) ;
                }
                return a.response.success
            }, onHandlerTerminate: function () {
                var b, a, c = this.chart, d = c.highlightedPoint;
                null === (b = c.tooltip) || void 0 === b ? void 0 : b.hide(0);
                null === (a = null === d || void 0 === d ? void 0 : d.onMouseOut) || void 0 === a ? void 0 : a.call(d);
                delete c.highlightedPoint
            }, attemptHighlightAdjacentPoint: function (b, a) {
                var c = this.chart, d = c.options.accessibility.keyboardNavigation.wrapAround;
                return c.highlightAdjacentPoint(a) ? b.response.success : d ? b.init(a ? 1 : -1) : b.response[a ?
                    "next" : "prev"]
            }, onSeriesDestroy: function (b) {
                var a = this.chart;
                a.highlightedPoint && a.highlightedPoint.series === b && (delete a.highlightedPoint, a.focusElement && a.focusElement.removeFocusBorder())
            }, destroy: function () {
                this.eventProvider.removeAddedEvents()
            }
        });
    ...
    r(a, "modules/accessibility/components/AnnotationsA11y.js", [a["parts/Utilities.js"], a["modules/accessibility/utils/htmlUtilities.js"]], function (a, g) {
        function l(a) {
            return (a.annotations || []).reduce(function (a, b) {
                var d;
                !1 !== (null === (d = b.options) ||
                void 0 === d ? void 0 : d.visible) && (a = a.concat(b.labels));
                return a
            }, [])
        }
        ...
        function n(a) {
            var d, b, e, c,
                k = null === (b = null === (d = a.options) || void 0 === d ? void 0 : d.accessibility) || void 0 === b ? void 0 : b.description;
            return k ? k : (null === (c = null === (e = a.graphic) || void 0 === e ? void 0 : e.text) || void 0 === c ? void 0 : c.textStr) || ""
        }

        function p(a) {
            var d, b,
                e = null === (b = null === (d = a.options) || void 0 === d ? void 0 : d.accessibility) || void 0 === b ? void 0 : b.description;
            if (e) return e;
            d = a.chart;
            b = n(a);
            e = a.points.filter(function (b) {
                return !!b.graphic
            }).map(function (b) {
                var a,
                    c;
                if (!(c = null === (a = null === b || void 0 === b ? void 0 : b.accessibility) || void 0 === a ? void 0 : a.valueDescription)) {
                    var d, e;
                    c = (null === (e = null === (d = null === b || void 0 === b ? void 0 : b.graphic) || void 0 === d ? void 0 : d.element) || void 0 === e ? void 0 : e.getAttribute("aria-label")) || ""
                }
            ...
            b = {annotationText: b, numPoints: c, annotationPoint: e[0], additionalAnnotationPoints: e.slice(1)};
            return d.langFormat(a, b)
        }

        function f(a) {
            return l(a).map(function (a) {
                return (a = x(k(p(a)))) ? "<li>" + a + "</li>" : ""
            })
        }

        var h = a.inArray, x = g.escapeStringForHTML, k = g.stripHTMLTagsFromString;
        return {
            getAnnotationsInfoHTML: function (a) {
                var d = a.annotations;
                return d && d.length ? "<ul>" + f(a).join(" ") + "</ul>" : ""
            }, getAnnotationLabelDescription: p, getAnnotationListItems: f, getPointAnnotationTexts: function (a) {
                var d = l(a.series.chart).filter(function (b) {
                    return -1 <
                        h(a, b.points)
                });
                return d.length ? d.map(function (b) {
                    return "" + n(b)
                }) : []
            }
        }
    ...
    r(a, "modules/accessibility/components/SeriesComponent/SeriesDescriber.js", [a["parts/Utilities.js"], a["modules/accessibility/components/AnnotationsA11y.js"], a["modules/accessibility/utils/htmlUtilities.js"], a["modules/accessibility/utils/chartUtilities.js"], a["parts/Tooltip.js"]], function (a, g, q, n, p) {
        function f(b) {
            var a = b.index;
            return b.series && b.series.data && D(a) ? C(b.series.data, function (b) {
        ...
        function h(b) {
            var a = b.chart.options.accessibility.series.pointDescriptionEnabledThreshold;
            return !!(!1 !== a && b.points && b.points.length >= a)
        }

        function l(b) {
            var a = b.options.accessibility || {};
            return !h(b) && !a.exposeAsGroupOnly
        }

        function k(b) {
            var a = b.chart.options.accessibility.keyboardNavigation.seriesNavigation;
            return !(!b.points || !(b.points.length < a.pointNavigationEnabledThreshold || !1 === a.pointNavigationEnabledThreshold))
        }
        ...
        function e(b, a) {
            ...
            c = c.options.lang;
            return u(a) ? I(a, d.valueDecimals || b.valueDecimals || -1, c.decimalPoint, c.accessibility.thousandsSep || c.thousandsSep) : a
        }

        function d(b) {
            var a = (b.options.accessibility || {}).description;
            return a && b.chart.langFormat("accessibility.series.description", {description: a, series: b}) || ""
        }

        function b(b, a) {
            return b.chart.langFormat("accessibility.series." + a + "Description", {name: J(b[a]), series: b})
        }

        function m(b) {
            var a = b.series, c = a.chart,
                d = c.options.accessibility.point || {};
            if (a.xAxis && a.xAxis.dateTime) return a = p.prototype.getXDateFormat.call({
                getDateFormat: p.prototype.getDateFormat,
                chart: c
            }, b, c.options.tooltip, a.xAxis), d = d.dateFormatter && d.dateFormatter(b) || d.dateFormat || a, c.time.dateFormat(d, b.x, void 0)
        }

        function c(b) {
            var a = m(b),
                c = (b.series.xAxis || {}).categories && D(b.category) && ("" + b.category).replace("<br/>", " "),
                d = b.id && 0 > b.id.indexOf("highcharts-"), e = "x, " + b.x;
            return b.name || a || c || (d ? b.id : e)
        }

        function t(b, a, c) {
            var d = a || "", m = c ||
                "";
            return b.series.pointArrayMap.reduce(function (a, c) {
                a += a.length ? ", " : "";
                var k = e(b, y(b[c], b.options[c]));
                return a + (c + ": " + d + k + m)
            }, "")
        }

        function A(b) {
            var a = b.series, c = a.chart.options.accessibility.point || {}, d = a.tooltipOptions || {},
                m = c.valuePrefix || d.valuePrefix || "";
            c = c.valueSuffix || d.valueSuffix || "";
            d = e(b, b["undefined" !== typeof b.value ? "value" : "y"]);
            return b.isNull ? a.chart.langFormat("accessibility.series.nullPointValue", {point: b}) : a.pointArrayMap ? t(b, m, c) : m + d + c
        }

        function z(b) {
            var a = b.series, d = a.chart,
                e = d.options.accessibility.point.valueDescriptionFormat,
                m = (a = y(a.xAxis && a.xAxis.options.accessibility && a.xAxis.options.accessibility.enabled, !d.angular)) ? c(b) : "";
            b = {
                point: b,
        ...
        function w(b) {
            var a = b.series, c = a.chart, d = z(b),
                e = b.options && b.options.accessibility && b.options.accessibility.description;
            e = e ? " " + e : "";
            a = 1 < c.series.length && a.name ? " " + a.name + "." : "";
            c = b.series.chart;
            var m = H(b), k = {point: b, annotations: m};
            c = m.length ?
                c.langFormat("accessibility.series.pointAnnotationsDescription", k) : "";
        ...
        function r(b) {
            var a = l(b), c = k(b);
            (a || c) && b.points.forEach(function (b) {
                var c;
                if (!(c = b.graphic && b.graphic.element) && (c = b.series && b.series.is("sunburst"), c = b.isNull && !c)) {
                    var d = b.series, e = f(b);
                    d = (c = e && e.graphic) ? c.parentGroup : d.graph || d.group;
                    e = e ? {x: y(b.plotX, e.plotX, 0), y: y(b.plotY, e.plotY, 0)} : {
                        x: y(b.plotX, 0),
                        y: y(b.plotY, 0)
                    };
                    e = b.series.chart.renderer.rect(e.x,
                        e.y, 1, 1);
                    e.attr({
                    ...
                    d && d.element ? (b.graphic = e, b.hasDummyGraphic = !0, e.add(d), d.element.insertBefore(e.element, c ? c.element : null), c = e.element) : c = void 0
                }
        ...
        function B(a) {
            var c = a.chart, e = c.types || [], m = d(a), k = function (b) {
                return c[b] && 1 < c[b].length && a[b]
            }, f = b(a, "xAxis"), u = b(a, "yAxis"), t = {
                name: a.name || "",
                ix: a.index + 1,
            ...
            return (c.langFormat("accessibility.series.summary." + a.type + e, t) || c.langFormat("accessibility.series.summary.default" + e, t)) + (m ?
                " " + m : "") + (k("yAxis") ? " " + u : "") + (k("xAxis") ? " " + f : "")
        }

        var C = a.find, v = a.format, u = a.isNumber, I = a.numberFormat, y = a.pick, D = a.defined,
            H = g.getPointAnnotationTexts, F = q.escapeStringForHTML, K = q.reverseChildNodes,
            G = q.stripHTMLTagsFromString, J = n.getAxisDescription, L = n.getSeriesFirstPointElement,
            M = n.getSeriesA11yElement, N = n.unhideChartElementFromAT;
        return {
            describeSeries: function (b) {
                var a = b.chart, c = L(b), d = M(b), e = a.is3d && a.is3d();
                if (d) {
                    d.lastChild !== c || e || K(d);
                    r(b);
                    N(a, d);
    ...
    r(a, "modules/accessibility/utils/Announcer.js", [a["parts/Globals.js"], a["modules/accessibility/utils/DOMElementProvider.js"], a["modules/accessibility/utils/htmlUtilities.js"]], function (a, g, q) {
        ...
        q = function () {
            ...
            a.prototype.addAnnounceRegion = function (a) {
                var f = this.chart.renderTo, g = this.domElementProvider.createElement("div");
                g.setAttribute("aria-hidden",
                    !1);
    ...
    r(a, "modules/accessibility/components/SeriesComponent/NewDataAnnouncer.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/utils/chartUtilities.js"], a["modules/accessibility/components/SeriesComponent/SeriesDescriber.js"], a["modules/accessibility/utils/Announcer.js"], a["modules/accessibility/utils/EventProvider.js"]], function (a, g, q, n, p, f) {
        ...
        var k = g.extend, e = g.defined, d = q.getChartTitle, b = n.defaultPointDescriptionFormatter,
            m = n.defaultSeriesDescriptionFormatter;
        g = function (b) {
            this.chart = b
        };
        k(g.prototype, {
            init: function () {
                var b = this.chart, a = b.options.accessibility.announceNewData.interruptUser ? "assertive" : "polite";
                ...
                var b = this, d = this.chart, e = this.eventProvider;
                e.addEvent(d, "afterDrilldown", function () {
                    b.lastAnnouncementTime = 0
                });
                e.addEvent(a.Series, "updatedData", function () {
                    b.onSeriesUpdatedData(this)
                });
                e.addEvent(d, "afterAddSeries", function (a) {
                    b.onSeriesAdded(a.series)
                });
                e.addEvent(a.Series, "addPoint", function (a) {
                    b.onPointAdded(a.point)
                });
                e.addEvent(d, "redraw", function () {
                    b.announceDirtyData()
                })
                ...
                this.chart === a && a.options.accessibility.announceNewData.enabled &&
                ...
                var c = this, e = this.chart.options.accessibility.announceNewData;
                if (e.enabled) {
                    var m = +new Date;
                    e = Math.max(0,
                        e.minAnnounceInterval - (m - this.lastAnnouncementTime));
                    b = l(this.queuedAnnouncement && this.queuedAnnouncement.series, b);
                    if (a = this.buildAnnouncementMessage(b, a, d)) this.queuedAnnouncement && clearTimeout(this.queuedAnnouncementTimer), this.queuedAnnouncement = {
                        ...
                        c && c.announcer && (c.lastAnnouncementTime = +new Date, c.announcer.announce(c.queuedAnnouncement.message), delete c.queuedAnnouncement, delete c.queuedAnnouncementTimer)
                                                   ...
                                                   e, k) {
                var f = this.chart, h = f.options.accessibility.announceNewData;
                if (h.announcementFormatter && (c = h.announcementFormatter(c, e, k), !1 !== c)) return c.length ? c : null;
                c = a.charts && 1 < a.charts.length ? "Multiple" : "Single";
                c = e ? "newSeriesAnnounce" + c : k ? "newPointAnnounce" + c : "newDataAnnounce";
                h = d(f);
                return f.langFormat("accessibility.announceNewData." + c, {
                    chartTitle: h,
                    seriesDesc: e ? m(e) : null,
    ...
    r(a, "modules/accessibility/components/SeriesComponent/forcedMarkers.js", [a["parts/Globals.js"],
        ...
        var n = g.addEvent, p = g.merge;
        return function () {
            n(a.Series, "render", function () {
                var a = this.options, h = !1 !== (this.options.accessibility && this.options.accessibility.enabled);
                ...
                if (h) {
                    ...
                    (this.a11yMarkersForced = !0, l(this.options)), this._hasPointMarkers && this.points && this.points.length) for (a = this.points.length; a--;) {
                        h = this.points[a];
                        var g = h.options;
                        delete h.hasForcedA11yMarker;
                        g.marker && (g.marker.enabled ? (p(!0, g.marker, {states: {normal: {opacity: g.marker.states && g.marker.states.normal && g.marker.states.normal.opacity || 1}}}), h.hasForcedA11yMarker = !1) : (l(g), h.hasForcedA11yMarker = !0))
                    }
    ...
    r(a, "modules/accessibility/components/SeriesComponent/SeriesComponent.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/AccessibilityComponent.js"], a["modules/accessibility/components/SeriesComponent/SeriesKeyboardNavigation.js"], a["modules/accessibility/components/SeriesComponent/NewDataAnnouncer.js"],
        ...
        g = g.extend;
        var e = h.hideSeriesFromAT, d = x.describeSeries;
        ...
        g(a.prototype, {
            init: function () {
                ...
                this.keyboardNavigation = new n(this.chart,
                    this.keyCodes);
    ...
    r(a, "modules/accessibility/components/ZoomComponent.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/AccessibilityComponent.js"],
        ...
        var h = g.extend, l = g.pick, k = p.unhideChartElementFromAT, e = f.setElAttrs, d = f.removeElement;
        a.Axis.prototype.panStep = function (b, a) {
            ...
            d = a.min + d;
            var e = c - d;
            0 > b && d < a.dataMin ? (d = a.dataMin, c = d + e) : 0 < b && c > a.dataMax && (c = a.dataMax, d = c - e);
        ...
        h(a.prototype, {
            init: function () {
                ...
                this[a] = this.createProxyButton(b, this[c], {"aria-label": e, tabindex: -1})
                ...
                return new n(k, {
                    keyCodeMap: [[[d.tab, d.up, d.down, d.left, d.right], function (b, a) {
                        ...
                        var b = c(this, k);
                        return l(b, this.response.success)
                    }]], validate: function () {
                        return k[b] && k[b].box && e[a]
                    }, init: function () {
                        k.setFocusToElement(k[b].box, e[a])
                    }
                })
            }, getKeyboardNavigation: function () {
    ...
    r(a, "modules/accessibility/components/RangeSelectorComponent.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/AccessibilityComponent.js"], a["modules/accessibility/KeyboardNavigationHandler.js"], a["modules/accessibility/utils/chartUtilities.js"], a["modules/accessibility/utils/htmlUtilities.js"]], function (a, g, q, n, p, f) {
        ...
        a.Chart.prototype.highlightRangeSelectorButton = function (a) {
            var e = this.rangeSelector.buttons, d = this.highlightedRangeSelectorItemIx;
        ...
        g(a.prototype, {
            onChartUpdate: function () {
                ...
                }), d.maxInput && d.minInput && ["minInput", "maxInput"].forEach(function (b, k) {
                    if (b = d[b]) h(a, b), e.setRangeInputAttrs(b, "accessibility.rangeSelector." + (k ? "max" : "min") + "InputLabel")
                }))
                ...
                l(a.element, {tabindex: -1, role: "button", "aria-label": e})
            }, setRangeInputAttrs: function (a,
                                             e) {
                var d = this.chart;
                l(a, {tabindex: -1, role: "textbox", "aria-label": d.langFormat(e, {chart: d})})
            }, getRangeSelectorButtonNavigation: function () {
                var a = this.chart, e = this.keyCodes, d = this;
                return new n(a, {
                    keyCodeMap: [[[e.left, e.right, e.up, e.down], function (a) {
                ...
                var d = a.response, b = this.keyCodes, k = this.chart,
                    c = k.options.accessibility.keyboardNavigation.wrapAround;
                e = e === b.left || e === b.up ? -1 : 1;
                return k.highlightRangeSelectorButton(k.highlightedRangeSelectorItemIx + e) ? d.success : c ? (a.init(e), d.success) : d[0 < e ? "next" : "prev"]
                ...
                var a = this.chart, e = this.keyCodes, d = this;
                return new n(a, {
                    keyCodeMap: [[[e.tab, e.up, e.down], function (a, k) {
                        return d.onInputKbdMove(this, a === e.tab && k.shiftKey || a === e.up ? -1 : 1)
                    }]], validate: function () {
    ...
    r(a, "modules/accessibility/components/InfoRegionsComponent.js", [a["parts/Globals.js"], a["parts/Utilities.js"], a["modules/accessibility/AccessibilityComponent.js"], a["modules/accessibility/utils/Announcer.js"], a["modules/accessibility/components/AnnotationsA11y.js"], a["modules/accessibility/utils/chartUtilities.js"], a["modules/accessibility/utils/htmlUtilities.js"]],
        function (a, g, q, n, p, f, h) {
            function l(a) {
                return a.replace(/&lt;(h[1-7]|p|div|ul|ol|li)&gt;/g, "<$1>").replace(/&lt;&#x2F;(h[1-7]|p|div|ul|ol|li|a|button)&gt;/g, "</$1>").replace(/&lt;(div|a|button) id=&quot;([a-zA-Z\-0-9#]*?)&quot;&gt;/g, '<$1 id="$2">')
            }

            var k = a.doc, e = g.extend, d = g.format, b = g.pick, m = p.getAnnotationsInfoHTML,
                c = f.unhideChartElementFromAT, t = f.getChartTitle, r = f.getAxisDescription, z = h.addClass,
                w = h.setElAttrs, E = h.escapeStringForHTML, B = h.stripHTMLTagsFromString, C = h.getElement,
                v = h.visuallyHideElement;
            ...
            e(g.prototype, {
                ...
                getLinkedDescriptionElement: function () {
                    ...
                    a && (a.setAttribute("aria-hidden", "true"), z(a, "highcharts-linked-description"))
                }, updateScreenReaderSection: function (a) {
                    var b = this.chart, d = this.screenReaderSections[a], e = d.buildContent(b),
                        f = d.element = d.element || this.createElement("div"),
                        k = f.firstChild || this.createElement("div");
                    ...
                    w(a, {id: "highcharts-screen-reader-region-" + b + "-" + c.index, "aria-label": d});
                ...
                defaultBeforeChartFormatter: function () {
                    ...
                    var k = "hc-linkto-highcharts-data-table-" + c.index, h = m(c),
                        g = c.langFormat("accessibility.screenReaderSection.annotations.heading", {chart: c});
                    e = {
                        chartTitle: t(c),
                    ...
                    var b =
                        this.chart;
                    b = b.langFormat("accessibility.table.viewAsDataTableButtonText", {chart: b, chartTitle: t(b)});
                    return '<a id="' + a + '">' + b + "</a>"
                }, getSonifyButtonText: function (a) {
                    var b, c = this.chart;
                    if (!1 === (null === (b = c.options.sonification) || void 0 === b ? void 0 : b.enabled)) return "";
                    b = c.langFormat("accessibility.sonification.playAsSoundButtonText", {chart: c, chartTitle: t(c)});
                    ...
                    var a =
                        this.chart, b = a.langFormat("accessibility.screenReaderSection.endOfChartMarker", {chart: a});
                    return '<div id="highcharts-end-of-chart-marker-' + a.index + '">' + b + "</div>"
                }, onDataTableCreated: function (a) {
                    var b = this.chart;
                    b.options.accessibility.enabled && (this.viewDataTableButton && this.viewDataTableButton.setAttribute("aria-expanded", "true"), a.html = a.html.replace("<table ", '<table tabindex="-1" summary="' + b.langFormat("accessibility.table.tableSummary", {chart: b}) + '"'))
                    ...
                    c && d && (w(c, {tabindex: "-1"}), c.onclick = function (a) {
                        var b;
                    ...
                    var b = this.viewDataTableButton = C(a), c = this.chart;
                    ...
                    b && (w(b, {
                        ...
                        "aria-expanded": !!C(a),
                        href: "#" + a
                    }), b.onclick = c.options.accessibility.screenReaderSection.onViewDataTableClick ||
                        function () {
                            c.viewData()
                        })
                    ...
                    var a = this.chart, c = function (c, d) {
                        ...
                        }, d = !!a.types && 0 > a.types.indexOf("map"), e = !!a.hasCartesianSeries,
                    ...
                    var b = this, c = this.chart, d = c[a];
                    return c.langFormat("accessibility.axis." +
                        a + "Description" + (1 < d.length ? "Plural" : "Singular"), {
                        chart: c,
                    ...
                    var b = a.options || {};
                    return b.accessibility && "undefined" !== typeof b.accessibility.rangeDescription ? b.accessibility.rangeDescription : a.categories ? this.getCategoryAxisRangeDesc(a) : !a.dateTime || 0 !== a.min && 0 !== a.dataMin ? this.getAxisFromToDescription(a) : this.getAxisTimeLengthDesc(a)
                    ...
                    var b = this.chart, c = b.options.accessibility.screenReaderSection.axisRangeDateFormat,
                        d = function (d) {
                            return a.dateTime ? b.time.dateFormat(c, a[d]) : a[d]
                        };
    ...
    r(a, "modules/accessibility/components/ContainerComponent.js", [a["parts/Globals.js"], a["parts/Utilities.js"],
        ...
        var f = a.win.document;
        a = g.extend;
        var h = q.stripHTMLTagsFromString, l = n.unhideChartElementFromAT, k = n.getChartTitle;
        q = function () {
        };
        q.prototype = new p;
        a(q.prototype, {
            ...
            handleSVGTitleElement: function () {
                ...
                if (b.length) {
                    var m = this.svgTitleElement = this.svgTitleElement || f.createElementNS("http://www.w3.org/2000/svg", "title");
                    m.textContent = b;
                    m.id = d;
                    a.renderTo.insertBefore(m, a.renderTo.firstChild)
                }
            }, setSVGContainerLabel: function () {
                var a = this.chart, d = h(a.langFormat("accessibility.svgContainerLabel", {chartTitle: k(a)}));
                a.renderer.box && d.length && a.renderer.box.setAttribute("aria-label",
                    d)
            }, setGraphicContainerAttrs: function () {
                var a = this.chart, d = a.langFormat("accessibility.graphicContainerLabel", {chartTitle: k(a)});
                ...
                var a =
                    this.chart, d = a.credits;
                d && (d.textStr && d.element.setAttribute("aria-label", h(a.langFormat("accessibility.credits", {creditsStr: d.textStr}))), l(a, d.element))
            }, destroy: function () {
    ...
    r(a, "modules/accessibility/high-contrast-mode.js", [a["parts/Globals.js"]], function (a) {
        ...
        return {
            isHighContrastModeActive: function () {
                ...
                var f = a.options.accessibility.highContrastTheme;
                a.update(f, !1);
                a.series.forEach(function (a) {
                    var h = f.plotOptions[a.type] || {};
                    a.update({
                    ...
                    a.points.forEach(function (a) {
                        a.options && a.options.color && a.update({
                            color: h.color || "windowText",
                            borderColor: h.borderColor || "window"
                        }, !1)
                    })
                });
                a.redraw()
    ...
    r(a, "modules/accessibility/options/deprecatedOptions.js", [a["parts/Utilities.js"]], function (a) {
        function g(a, e, d) {
            for (var b, f = 0; f < e.length - 1; ++f) b = e[f], a = a[b] = x(a[b], {});
            a[e[e.length - 1]] = d
        }
        ...
        function l(a, e, d, b) {
            ...
            var c = f(a.options, e), k = f(a.options, d);
            Object.keys(b).forEach(function (f) {
                var m,
                    l = c[f];
                "undefined" !== typeof l && (g(k, b[f], l), h(32, !1, a, (m = {}, m[e.join(".") + "." + f] = d.join(".") + "." + b[f].join("."), m)))
            })
        }

        function n(a) {
            var e = a.options.chart || {}, d = a.options.accessibility || {};
            ["description", "typeDescription"].forEach(function (b) {
                var f;
                e[b] && (d[b] = e[b], h(32, !1, a, (f = {}, f["chart." + b] = "use accessibility." + b, f)))
            })
        }

        function p(a) {
            a.axes.forEach(function (e) {
                (e = e.options) && e.description && (e.accessibility = e.accessibility || {}, e.accessibility.description = e.description, h(32, !1, a, {"axis.description": "use axis.accessibility.description"}))
            })
        }
        ...
        function f(a) {
            ...
            a.series.forEach(function (d) {
                Object.keys(e).forEach(function (b) {
                    var f, c = d.options[b];
                    "undefined" !== typeof c && (g(d.options, e[b], "skipKeyboardNavigation" === b ? !c : c), h(32, !1, a, (f = {}, f["series." + b] = "series." + e[b].join("."), f)))
                })
            })
        }
        ...
        return function (a) {
            ...
            l(a, ["lang", "accessibility"], ["lang", "accessibility"], {
                ...
                svgContainerEnd: ["screenReaderSection",
                    "endOfChartMarker"],
    ...
    r(a, "modules/accessibility/a11y-i18n.js", [a["parts/Globals.js"], a["parts/Utilities.js"]], function (a, g) {
        function l(a, h) {
            var f = a.indexOf("#each("), k = a.indexOf("#plural("), e = a.indexOf("["), d = a.indexOf("]");
            if (-1 < f) {
                e = a.slice(f).indexOf(")") + f;
                var b = a.substring(0, f);
                k = a.substring(e + 1);
                e = a.substring(f + 6, e).split(",");
                f = Number(e[1]);
                a = "";
                if (h = h[e[0]]) for (f = isNaN(f) ? h.length : f, f = 0 > f ? h.length +
                    f : Math.min(f, h.length), e = 0; e < f; ++e) a += b + h[e] + k;
                return a.length ? a : ""
            }
            if (-1 < k) {
            ...
            return -1 < e ? (k = a.substring(0, e), a = Number(a.substring(e + 1, d)), h = h[k], !isNaN(a) && h && (0 > a ? (b = h[h.length + a], "undefined" === typeof b && (b = h[0])) : (b = h[a], "undefined" === typeof b && (b =
                h[h.length - 1]))), "undefined" !== typeof b ? b : "") : "{" + a + "}"
        }

        var n = g.format, p = g.pick;
        a.i18nFormat = function (a, h, g) {
            var f = function (a, b) {
                a = a.slice(b || 0);
            ...
            do {
                var b = f(a, d);
                var m = a.substring(d, b && b.begin - 1);
                m.length && e.push({value: m, type: "constant"});
                b && e.push({value: b.statement, type: "statement"});
                d = b ? b.end + 1 : d + 1
            } while (b);
            e.forEach(function (a) {
                "statement" === a.type && (a.value = l(a.value, h))
            });
            return n(e.reduce(function (a,
                                        b) {
                return a + b.value
            }, ""), h, g)
        };
        a.Chart.prototype.langFormat = function (f, h) {
            f = f.split(".");
            for (var g = this.options.lang, k = 0; k < f.length; ++k) g = g && g[f[k]];
    ...
    r(a, "modules/accessibility/focusBorder.js", [a["parts/Globals.js"], a["parts/SVGElement.js"], a["parts/SVGLabel.js"], a["parts/Utilities.js"]], function (a, g, q, n) {
            ...
            if (!a.focusBorderDestroyHook) {
                ...
                a.destroy = function () {
                    ...
                    null === (d = null === (c = a.focusBorder) || void 0 === c ? void 0 :
                        c.destroy) || void 0 === d ? void 0 : d.call(c);
        ...
        function h(a) {
            a.focusBorderUpdateHooks && (Object.keys(a.focusBorderUpdateHooks).forEach(function (b) {
                var c =
                    a.focusBorderUpdateHooks[b];
                c === a._defaultSetter ? delete a[b] : a[b] = c
            }), delete a.focusBorderUpdateHooks)
        }

        var r = n.addEvent, k = n.extend, e = n.pick, d = "x y transform width height r d stroke-width".split(" ");
        k(g.prototype, {
            addFocusBorder: function (b, d) {
                this.focusBorder && this.removeFocusBorder();
                var c = this.getBBox(), g = e(b, 3);
                c.x += this.translateX ? this.translateX : 0;
                c.y += this.translateY ? this.translateY : 0;
                var h = c.x - g, k = c.y - g, m = c.width + 2 * g, n = c.height + 2 * g, p = this instanceof q;
                if ("text" === this.element.nodeName || p) {
                    ...
                    if (p) var v = {
                        x: r ? 1 : 0,
                        y: 0
                    }; else h = v = 0, "middle" === this.attr("text-anchor") ? (v = a.isFirefox && this.rotation ? .25 : .5, h = a.isFirefox && !this.rotation ? .75 : .5) : this.rotation ? v = .25 : h = .75, v = {
                        x: v,
                        y: h
                    };
                    h = +this.attr("x") - c.width * v.x - g;
                    k = +this.attr("y") - c.height * v.y - g;
                    p && r && (p = m, m = n, n = p, h = +this.attr("x") - c.height * v.x - g, k = +this.attr("y") - c.width * v.y - g)
                }
        ...
        a.Chart.prototype.renderFocusBorder = function () {
            var a = this.focusElement, d = this.options.accessibility.keyboardNavigation.focusBorder;
            a && (a.removeFocusBorder(), d.enabled &&
        ...
        a.Chart.prototype.setFocusToElement = function (a, d) {
            ...
            (d = d || a.element) && d.focus && (d.hcEvents && d.hcEvents.focusin || r(d, "focusin", function () {
            }), d.focus(), b.hideBrowserFocusOutline && (d.style.outline = "none"));
            this.focusElement && this.focusElement.removeFocusBorder();
            this.focusElement = a;
    ...
    r(a, "modules/accessibility/accessibility.js",
        [a["modules/accessibility/utils/chartUtilities.js"], a["parts/Globals.js"], a["modules/accessibility/KeyboardNavigationHandler.js"], a["parts/Options.js"], a["parts/Point.js"], a["parts/Utilities.js"], a["modules/accessibility/AccessibilityComponent.js"], a["modules/accessibility/KeyboardNavigation.js"], a["modules/accessibility/components/LegendComponent.js"], a["modules/accessibility/components/MenuComponent.js"], a["modules/accessibility/components/SeriesComponent/SeriesComponent.js"], a["modules/accessibility/components/ZoomComponent.js"],
            ...
            var v = f.addEvent, u = f.extend, x = f.fireEvent, y = f.merge, D = g.win.document;
            y(!0, n.defaultOptions, w, {accessibility: {highContrastTheme: z}, lang: E});
            g.A11yChartUtilities = a;
            g.KeyboardNavigationHandler = q;
            g.AccessibilityComponent = h;
            l.prototype = {
                init: function (a) {
                    this.chart = a;
                    ...
                    f.customComponents && u(this.components, f.customComponents);
